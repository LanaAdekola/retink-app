    ...
    <div className='wrapper'>
      <div className='info-first-container'>
        <div className='info-second-container'>
          ...
          <p className ='text info-text'>Boost your sales <span>10x faster </span>with content customized by our unique partnership of <span>human creativity and AI optimization.</span></p>
